...
def attack(char_name: str, char_class: str) -> str:
    """Функция атаки.
    Определяет урон в зависимости от класса персонажа.
    """
...
def defence(char_name: str, char_class: str) -> str:
    """Функция защиты.
    Определяет количество отраженного урона
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция тренировки. Взаимодействие с игроком.
    Принимает команды игрока и вызывает соответствующие функции игры.
    """
    if char_class == 'warrior':
